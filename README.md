...
See [product scope](docs/product.md), [architecture](docs/architecture.md), [research](docs/research/2026-09-09-infisical-api-and-versions.md), and [decisions](docs/decisions/index.md).
