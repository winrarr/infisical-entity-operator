...
The operator is organized around a dependency-aware reconciliation graph and a small typed Infisical client boundary.
...
- The [resource index](../reference/resources.md) maps the seven CRDs and their dependencies.
