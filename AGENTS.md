...
Read `docs/development/architecture.md`, `docs/development/operations/local-kind.md`, and the relevant decision records before changing external API behavior or local cluster networking.

## Durable project knowledge

- `docs/index.md` is the documentation home and audience guide.
- `docs/usage/` contains installation, configuration, CRD, reference, example, security, and troubleshooting documentation for operator users.
- `docs/development/architecture.md` describes component boundaries and reconciliation flow.
- `docs/development/research/` contains dated, source-backed Infisical API and dependency research.
- `docs/development/decisions/` contains accepted design decisions and their rationale.
- `docs/development/project/backlog.md` contains intended future outcomes that are not implemented.
- `docs/development/project/tech-debt.md` contains material known shortcomings intentionally left unresolved.
- `docs/development/project/verification.md` explains what each check proves and the limits of local evidence.
- `docs/development/operations/` contains safety-sensitive local deployment and troubleshooting procedures.
- `zensical.toml` defines the documentation site navigation and strict build settings.
- `docs/usage/reference/api.md` is generated by `make generate-api-reference`; do not edit it directly.
